...
export const STATIC_TEAMS: Team[] = [
  ...
  team('arsenal','Arsenal','ARS',42,'red'), team('manchester-city','Manchester City','MCI',50,'blue'), team('manchester-united','Manchester United','MUN',33,'red'), team('liverpool','Liverpool','LIV',40,'red'), team('chelsea','Chelsea','CHE',49,'blue'), team('tottenham-hotspur','Tottenham Hotspur','TOT',47,'white'),
