...
export function PlayerIcon({ player, team, className = 'h-10 w-10 text-[11px]', badges, onClick }: { player?: Player; team?: Team; className?: string; badges?: React.ReactNode; onClick?: () => void }) {
  const content = (
