...
export function GlobalRankingScreen({ season, teamId, screenState, onStateChange, onNavigate, onBack }: { season: string; teamId?: string; screenState: ScreenStateByView['global-ranking']; onStateChange: (state: ScreenStateByView['global-ranking']) => void; onNavigate: (view: View) => void; onBack: () => void }) {
