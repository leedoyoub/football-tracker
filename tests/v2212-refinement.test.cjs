...
test('v2.3.2 keeps package, lockfile, app version, rating revision, and storage namespace aligned', () => {
  ...
  assert.equal(require('../package-lock.json').packages[''].version, '2.3.2')
